...
<head>
  ...
  <title>Julian Harris — Parks & Recreation Portfolio</title>
  ...
  <style>
    ...
    *{box-sizing: border-box}
    ...
    header.site-header{
      ...
      gap:12px;
      background: linear-gradient(90deg, rgba(122,0,25,0.06), rgba(255,209,0,0.03));
      border-radius:12px;
      padding:12px 18px;
    }
    ...
    .logo-svg{width:62px;height:62px;flex:0 0 62px}
    .brand h1{
      font-size:1.15rem;
      margin:0;
      color:var(--maroon);
